...
for x in ['LJ011-0015', 'LJ014-0028', 'LJ012-0061', 'LJ008-0124']:
    ...
    out.write(f'<div class="r-number" onclick="document.getElementById(\'{x}_gt\').play()">GT</div>\n')
    ...
    out.write(f'<div class="r-number" onclick="document.getElementById(\'{x}_gtvoc\').play()">Voc</div>\n')
...
for i in range(1, len(temp) + 1):
    ...
    for r in ['2', '3', '5', '7', '10']:
        out.write('<div class="sample-audio">\n')
        out.write(f'<div class="r-number" onclick="document.getElementById(\'{i}_{r}\').play()">r{r}</div>\n')
